...
public class CameraCapture2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEdtPw1 = findViewById(R.id.edtPwd1);
        mEdtPw2 = findViewById(R.id.edtPwd2);
    ...
    private void joinProcess() {
        ...
        // 아이디가 공백인지 체크한다.
        // TextUtils.isEmpty() : 문자열객체가 null 또는 공백문자 둘다 비엇다고 판단함
        ...
        if(findMemBean != null){
            // 해당되는 아이디를 찾았다.
            Toast.makeText(this, "입력하신 회원아이디는 이미 존재합니다.", Toast.LENGTH_LONG).show();
            return;
        }
    ...
    private void sendPicture() {
        ...
        Toast.makeText(this, "사진경로" + mPhotoPath,Toast.LENGTH_LONG).show(); // 우리는 사진의 경로를 저장하므로 사진의 경로를 확인함
    }  // end Sendpicture
